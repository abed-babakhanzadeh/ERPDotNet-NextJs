              ...
              {isLoading ? (
                ...
                data.map((row, index) => (
                  <TableRow
                    ...
                    className={cn(
                      "cursor-pointer border-b border-border transition-colors h-8",
                      "hover:bg-muted/40",
                        ...
                        <div className="truncate flex items-center">
                          {column.render ? (
                            ...
                            <Badge
                              ...
                              className={cn(
                                "text-white font-medium shadow-sm text-[10px] h-4 px-1.5",
                                row.isActive
